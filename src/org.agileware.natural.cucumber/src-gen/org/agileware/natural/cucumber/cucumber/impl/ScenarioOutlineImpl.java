 ...
 * </p>
 * <ul>
 *   <li>{@link org.agileware.natural.cucumber.cucumber.impl.ScenarioOutlineImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link org.agileware.natural.cucumber.cucumber.impl.ScenarioOutlineImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.agileware.natural.cucumber.cucumber.impl.ScenarioOutlineImpl#getNarrative <em>Narrative</em>}</li>
 *   <li>{@link org.agileware.natural.cucumber.cucumber.impl.ScenarioOutlineImpl#getSteps <em>Steps</em>}</li>
 *   <li>{@link org.agileware.natural.cucumber.cucumber.impl.ScenarioOutlineImpl#getExamples <em>Examples</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioOutlineImpl extends MinimalEObjectImpl.Container implements ScenarioOutline
{
  ...
  public void setNarrative(String newNarrative)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CucumberPackage.SCENARIO_OUTLINE__NARRATIVE, oldNarrative, narrative));
  }
  ...
  public NotificationChain basicSetExamples(Examples newExamples, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CucumberPackage.SCENARIO_OUTLINE__EXAMPLES, oldExamples, newExamples);
  ...
  public void setExamples(Examples newExamples)
  {
    if (newExamples != examples)
    {
      ...
      if (examples != null)
        msgs = ((InternalEObject)examples).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CucumberPackage.SCENARIO_OUTLINE__EXAMPLES, null, msgs);
      if (newExamples != null)
        msgs = ((InternalEObject)newExamples).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CucumberPackage.SCENARIO_OUTLINE__EXAMPLES, null, msgs);
      msgs = basicSetExamples(newExamples, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CucumberPackage.SCENARIO_OUTLINE__EXAMPLES, newExamples, newExamples));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case CucumberPackage.SCENARIO_OUTLINE__TITLE:
        return getTitle();
      case CucumberPackage.SCENARIO_OUTLINE__NARRATIVE:
        return getNarrative();
      case CucumberPackage.SCENARIO_OUTLINE__STEPS:
        return getSteps();
      case CucumberPackage.SCENARIO_OUTLINE__EXAMPLES:
