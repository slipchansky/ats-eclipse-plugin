...
public class InternalCucumberLexer extends Lexer {
    ...
    public final void mRULE_STEP_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:2583:19: ( ( 'Stas' | 'Given' | 'When' | 'Then' | 'And' | 'But' ) ( ' ' | '\\t' )+ )
            // InternalCucumber.g:2583:21: ( 'Stas' | 'Given' | 'When' | 'Then' | 'And' | 'But' ) ( ' ' | '\\t' )+
            {
            // InternalCucumber.g:2583:21: ( 'Stas' | 'Given' | 'When' | 'Then' | 'And' | 'But' )
            int alt5=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt5) {
                case 1 :
                    // InternalCucumber.g:2583:22: 'Stas'
                    {
                    match("Stas"); 
                    ...
                    break;
                case 2 :
                    // InternalCucumber.g:2583:29: 'Given'
                    {
                    match("Given"); 
                    ...
                    break;
                case 3 :
                    // InternalCucumber.g:2583:37: 'When'
                    {
                    match("When"); 
                    ...
                    break;
                case 4 :
                    // InternalCucumber.g:2583:44: 'Then'
                    {
                    match("Then"); 
                    ...
                    break;
                case 5 :
                    // InternalCucumber.g:2583:51: 'And'
                    {
                    match("And"); 
                    ...
                    break;
                case 6 :
                    // InternalCucumber.g:2583:57: 'But'
                    {
                    match("But"); 
    ...
    public final void mRULE_PLACEHOLDER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:2585:18: ( '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>' )
            // InternalCucumber.g:2585:20: '<' (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+ '>'
            {
            match('<'); 
            // InternalCucumber.g:2585:24: (~ ( ( '>' | ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_TAGNAME() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCucumber.g:2595:14: ( '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+ )
            // InternalCucumber.g:2595:16: '@' (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            {
            match('@'); 
            // InternalCucumber.g:2595:20: (~ ( ( ' ' | '\\t' | '\\n' | '\\r' ) ) )+
            int cnt18=0;
            loop18:
            do {
                int alt18=2;
